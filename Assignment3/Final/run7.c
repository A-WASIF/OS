...
void prepAndLaunch_schduler(struct Queue* q1, struct Queue* q2, struct Queue* q3, struct Queue* q4, int TSLICE, int NCPU, HistoryEntry history[], int historyIndex){
    ...
    initializeWaitTime(history, historyIndex, 3, TSLICE, numProcess2 / NCPU + numProcess1 / NCPU);
    initializeWaitTime(history, historyIndex, 4, TSLICE, numProcess3 / NCPU + numProcess2 / NCPU + numProcess1 / NCPU);
